...
#define _AMIC_TRACK CONFIG_TYPE_AMIC_TRACK
#else
#define _AMIC_TRACK 0
#endif

#ifdef CONFIG_TYPE_DMIC
#define _DMIC_TRACK CONFIG_TYPE_DMIC_TRACK
#else
#define _DMIC_TRACK 0
#endif

#ifdef CONFIG_TYPE_I2S
#define _I2S_TRACK CONFIG_TYPE_I2S_TRACK
#else
#define _I2S_TRACK 0
#endif

#if ((_AMIC_TRACK + _DMIC_TRACK + _I2S_TRACK) != CONFIG_MIC_CHANNEL_NUM)
#error The Mic-num you set is NOT EQUAL the Mic-channel-num!
#endif
