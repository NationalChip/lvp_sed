...
/******************************************************************************
 * @file     core_ck804.h
 * @brief    CSI CK804 Core Peripheral Access Layer Header File
 * @version  V1.0
 * @date     02. June 2017
 ******************************************************************************/

#ifndef __CORE_CK804_H_GENERIC
#define __CORE_CK804_H_GENERIC
...
/**
  ...
  \details Get active interrupt number
  \param [out] active interrrupt number
 */
__STATIC_INLINE uint32_t csi_vic_get_active_irq(void)
{
    return VIC->ISR & 0x1FF;
}
...
#endif /* __CORE_CK804_H_DEPENDANT */
