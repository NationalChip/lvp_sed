...
{
#ifndef CONFIG_BOOT_BY_UART
	printf("./loader_write inputfile outputfile head_size stage1_size stage1_copy_count stage2_xip_len\n\n");
#else
	printf("./loader_write inputfile outputfile head_size stage1_size stage1_copy_count \n\n");
#endif
}
...
int main(int argc, char* argv[])
{
	...
	crc_res = CRC32(buf + header_size, stage1_size - 4 - header_size);
	*(unsigned int *)(buf + stage1_size - 4) = crc_res; //stage1 end 4bytes is crc32
...
#ifndef CONFIG_BOOT_BY_UART
	/* write loader.bin header*/
	fwrite(&stage2_xip_len, 1, 4, file_w);
	fseek(file_r, 4, SEEK_CUR);
#endif
