...
DRAM0_STAGE2_SRAM_ATTR int16 mult_int16_r(int16 var1, int16 var2)
{
    int32 L_product_arr;
...
DRAM0_STAGE2_SRAM_ATTR int16 shr_rnd(int16 var1, int16 var2)
{
    int16 var_out;
...
DRAM0_STAGE2_SRAM_ATTR int16 div_16by16(int16 var1, int16 var2)
{
...
/*----------------------------------------------------------------------------
  ...
  Algorithm:
     ...
     3- L_y = L_x << exponant
 ----------------------------------------------------------------------------*/
DRAM0_STAGE2_SRAM_ATTR int32 one_ov_sqrt(     /* (o) Q31 : output value (range: 0<=val<1)         */
...
DRAM0_STAGE2_SRAM_ATTR void one_ov_sqrt_norm(
...
DRAM0_STAGE2_SRAM_ATTR int32 power_of_2(                         /* (o) Q0  : result       (range: 0<=val<=0x7fffffff) */
...
DRAM0_STAGE2_SRAM_ATTR int32 Dot_product12(   /* (o) Q31: normalized result (1 < val <= -1) */
 ...
 *
----------------------------------------------------------------------------*/
DRAM0_STAGE2_SRAM_ATTR void Lg2_normalized(
 ...
 *
 ----------------------------------------------------------------------------*/
DRAM0_STAGE2_SRAM_ATTR void amrwb_log_2(
...
DRAM0_STAGE2_SRAM_ATTR void int32_to_dpf(int32 L_32, int16 *hi, int16 *lo)
{
    *hi = (int16)(L_32 >> 16);
...
DRAM0_STAGE2_SRAM_ATTR int32 mpy_dpf_32(int16 hi1, int16 lo1, int16 hi2, int16 lo2)
{
    int32 L_32;
