...
DRAM0_STAGE2_SRAM_ATTR static Word32 energy_old(       /* o : return energy of signal      */
...
DRAM0_STAGE2_SRAM_ATTR Word32 energy_old_Wrapper(Word16 in[], Word16 l_trm, Flag *pOverflow)
{
...
DRAM0_STAGE2_SRAM_ATTR static Word32 energy_new(       /* o : return energy of signal      */
    Word16 in[],        /* i : input signal (length l_trm)  */
    Word16 l_trm,       /* i : signal length                */
...
DRAM0_STAGE2_SRAM_ATTR void agc2(
