...
/**
 * @brief 停止 snpu 工作，未完成的任务被丢弃。（注：该接口不能在中断运行）
 *
 * @return snpu 工作状态
 * @retval 0  正常
 * @retval -1 失败
 */
int gx_snpu_stop(void);

/**
 * @brief 暂停 snpu 工作，未完成的任务被暂停但不会丢弃，需要和 gx_snpu_resume 接口配合使用。（注：该接口不能在中断运行）
 *
 * @return snpu 工作状态
 * @retval 0  正常
 * @retval -1 失败
...
/**
 * @brief 恢复 snpu 工作，恢复暂停时的未完成任务，需要和 gx_snpu_pause 接口配合使用。（注：该接口不能在中断运行）
 *
 * @return snpu 工作状态
 * @retval 0  正常
 * @retval -1 失败
